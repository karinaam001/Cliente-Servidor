 ...
 */
public class Cliente2 extends Conexion
{
    public Cliente2() throws IOException{super("cliente2");} //Se usa el constructor para cliente de Conexion
    ...
    public void startClient() throws IOException //Método para iniciar el cliente
    {
        ...
        try
        {
            ...
            salidaServidor = new DataOutputStream(cs2.getOutputStream());
            System.out.println("Bienvenido al Cliente 2.");
                ...
                switch(opc){
                          ...
                          case 7: 
                            ...
                            break; 
                              ...
                              cliente=sc.nextInt(); 
                              if (cliente==1) {cli1.startClient();cs2.close();}
                              if (cliente==2) {cli2.startClient();cs2.close();}
                              if (cliente==3) {cli3.startClient();cs2.close();}
                              if (cliente==4) {cli4.startClient();cs2.close();}
                              if (cliente==5){
                                  cs1.close(); 
                                  cs2.close();
                                  cs3.close();
