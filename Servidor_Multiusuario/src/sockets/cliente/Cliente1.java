 ...
 */
public class Cliente1 extends Conexion
{
    public Cliente1() throws IOException{super("cliente1");} //Se usa el constructor para cliente de Conexion

    public void startClient() throws IOException //Método para iniciar el cliente
    {  
        Scanner sc= new Scanner(System.in); 
        int opc,num,lenght=0,cliente; 
        ...
        {   //Flujo de datos hacia el servidor
            salidaServidor = new DataOutputStream(cs1.getOutputStream());
            System.out.println("Bienvenido al Cliente 1 ");
                ...
                switch(opc){
                          ...
                          case 5: 
                            ...
                            break;
                          case 6:  
                              System.out.println("1. Cliente 2");
                              System.out.println("2. Cliente 3");
                          ...
                          case 7: 
                            ...
                            break; 
                              ...
                              cliente=sc.nextInt(); 
                              if (cliente==1) {cli1.startClient();cs1.close();}
                              if (cliente==2) {cli2.startClient();cs1.close();}
                              if (cliente==3) {cli3.startClient();cs1.close();}
                              if (cliente==4) {cli4.startClient();cs1.close();}
                              if (cliente==5){
                                  cs1.close(); 
                                  cs2.close();
                                  cs3.close();
